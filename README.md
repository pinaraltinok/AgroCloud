...
![AgroCloud Logo](docs/images/logo.png)
...
![System Mockup](docs/images/setup.png)
...
2. **Configuration**:
   ...
   - Set up your "Thing" on [Arduino IoT Cloud](https://create.arduino.cc/iot/things) with the properties defined in `thingProperties.h`.
3. **Wiring**:
   - Connect sensors and actuators according to the [Hardware Table](#️-hardware-components).
4. **Upload**:
...
Developed with ❤️ by [Pinar Altinok](https://github.com/pinaraltinok)
